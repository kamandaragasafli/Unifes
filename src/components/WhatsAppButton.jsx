...
const WhatsAppButton = () => {
  const phoneNumber = '+994702097789'
  const message = 'Salam, məhsullarınız haqqında məlumat almaq istərdim.'
  ...
  return (
    <button className="whatsapp-button" onClick={handleClick} aria-label="WhatsApp ilə əlaqə">
